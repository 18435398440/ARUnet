...
class Unet(nn.Module):
    def __init__(self, input_channel, output_channel):
        ...
        # self.bot1 = Bottleneck(64, 64)
        # self.bot2 = Bottleneck(128, 128)
        # self.bot3 = Bottleneck(256, 256)
        # self.bot4 = Bottleneck(512, 512)
        # self.bot5 = Bottleneck(1024, 1024)
    ...
    def forward(self, x):
        ...
        merge7= self.cbam4(merge7)+merge7
        c7 = self.conv7(merge7)

        up_8 = self.up8(c7)
        merge8 = torch.cat([up_8, c2], dim=1)
        merge8 = self.cbam3(merge8)+merge8
        c8 = self.conv8(merge8)

        up_9 = self.up9(c8)
        merge9 = torch.cat([up_9, c1], dim=1)
        merge9 = self.cbam2(merge9)+merge9
...
def Unet_feature():
    images = np.random.rand(2,3, 480, 320)
